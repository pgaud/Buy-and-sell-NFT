...
```
dfx canister call <principal id without double quots> transferOwnerShip '(principal "hozae-racaq-aaaaa-aaaaa-c", true)'
```
...
2. get the canister id of token canister using dfx canister id token

3. Set the token canister id into the <REPLACE_WITH_TOKEN_CANISTER_ID>
